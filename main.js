...
var x = setInterval(function() {
	...
	if (days >= 1) {
		document.getElementById("frase").innerHTML = "Ainda faltam " + days + " dias para a sua prova, aproveita que ainda tem tempo, e reveja aquele conteúdo que te deixou meio confuso. Vai com tudo !";
